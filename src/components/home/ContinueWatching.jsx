...
function ContinueWatching () {
  ...
  return (
    <SectionWrapper title="Continue Watching">
      <HStack spacing="3rem">
        {items.map(item => (
          <Resume key={item} w="300px" h="56.25%" pos="relative" cursor="pointer">
            <AspectRatio ratio={16 / 9}>
              <Image src="https://i.insider.com/5eb97ff7cdfd480a6265c298?width=1100&format=jpeg&auto=webp" alt="naruto" objectFit="cover" filter="grayscale(90%)" transition="all .5s" />
            </AspectRatio>
