...
function Banner () {
  return (
    <Box w="100%" h="500px" bg={`linear-gradient(180deg, rgba(13,2,2,0) 0%, rgba(0,0,0,0.6629026610644257) 54%), url(${blacklist})`} backgroundSize="cover" pos="relative" borderRadius={['0', '0', '1rem']}>
